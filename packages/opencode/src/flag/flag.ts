...
export namespace Flag {
  ...
  // Offline mode flags
  export const OPENCODE_OFFLINE = truthy("OPENCODE_OFFLINE")
  export const OPENCODE_DISABLE_TELEMETRY = truthy("OPENCODE_DISABLE_TELEMETRY")
  export const OPENCODE_DISABLE_ACCOUNT = truthy("OPENCODE_DISABLE_ACCOUNT")
